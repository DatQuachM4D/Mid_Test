...
const NewMovies = () => {
  const Movies = [
    ...
    },
    {
      ...
      image: "./Image/boruto-naruto-next-generations.png",
  ...
  return (
    <>
      <p className="text-4xl font-semibold text-white mb-[24px]">New Release</p>
